            ...
            l = (function () {
                function e(t) {
                    ...
                    (this.config = i(
                        ...
                        (this._closeAfterTransition = this._closeAfterTransition.bind(
                            this
                        ));
                }
                var t, n, s;
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                (this.isOpened = !1),
                                    ...
                                    (this._modalBlock = !1),
                                    e._shadow ||
                                        ((e._shadow = document.createElement(
                                            "button"
                                        )),
                                ...
                                document.addEventListener(
                                    ...
                                    function (e) {
                                        ...
                                        if (!this._isMoved && t) {
                                            ...
                                            return (
                                                (this._nextWindows = document.querySelector(
                                                    n
                                                )),
                                                void this.open()
                                            );
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                if (
                                    ...
                                    if (this.isOpened)
                                        return (
                                            (this._reopenTrigger = !0),
                                            void this.close()
                                        );
                                    (this.openedWindow = this._nextWindows),
                                        (this._modalBlock = this.openedWindow.querySelector(
                                            ".hystmodal__window"
                                        )),
